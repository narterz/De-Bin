...
export default function FileTypeSelect({ file }: { file: FileState }){
    ...
    return (
        <Select onValueChange={handleSelection} onOpenChange={handleToggleSelect} >
            <SelectTrigger className="file-select-trigger bg-accent text-white border-none flex items-center justify-end w-1/2">
                <SelectValue placeholder={conversion} className="text-black bg-black"/>
            </SelectTrigger>
